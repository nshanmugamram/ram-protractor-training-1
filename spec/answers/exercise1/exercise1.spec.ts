...
describe("Exercise 1 - ", () => {
    ...
    describe("when user open the contact info form - ", () => {
        ...
        it('should find element by binding', function() {
            ...
            expect(phoneDisplay.isPresent()).toBeTruthy();
        });
        ...
        it('should get element text', function() {
            ...
            expect(emailDisplay.getText()).toMatch("bruce.lee@google.com")
         });
        ...
        it('should get input text', function() {
            ...
            var emailInput = element(by.model('ctrl.user.email'));
            expect(emailInput.getAttribute("value")).toMatch("bruce.lee@google.com");
            });
        ...
        it('should set input text', function() {
            ...
            expect(nameInput.getAttribute("value")).toMatch("Christian Crowhurst");
        })
    });
    ...
    describe("when update the contact info detail - ", () => {
        it('should update contact information', function() {
            ...
            expect(nameDisplay.getText()).toMatch("Christian Crowhurst");
        });
    })
